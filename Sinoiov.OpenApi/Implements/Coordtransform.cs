...
public class Coordtransform
{
    ...
    /// <returns></returns>
    public static (double lon, double lat) Bd09togcj02(double bd_lon, double bd_lat)
    {
    ...
    /// <returns></returns>
    public static (double lon, double lat) Gcj02tobd09(double lng, double lat)
    {
    ...
    /// <param name="lat"></param>
    /// <returns></returns>
    public static (double lon, double lat) Wgs84togcj02(double lng, double lat)
    {
    ...
    /// <param name="lat"></param>
    /// <returns></returns>
    public static (double lon, double lat) Gcj02towgs84(double lng, double lat)
    {
        if (Out_of_china(lng, lat))
        {
            return (lng, lat);
    ...
    /// <param name="bd_lat"></param>
    /// <returns></returns>
    public static (double lon, double lat) Bd09towgs84(double bd_lon, double bd_lat)
    {
